...
LOCAL_FIELD_RULES = {
    ...
    "organization": ("公司", "单位", "机构", "企业", "甲方", "乙方", "供应商", "采购方", "购买方", "销售方"),
    "date": ("日期", "时间", "期限", "年月日", "签订日期", "签约日期", "开票日期"),
    "amount": ("金额", "费用", "预算", "价格", "报价", "总价", "价税合计", "合同金额"),
    "phone": ("电话", "手机", "联系方式", "联系电话"),
    "email": ("邮箱", "邮件", "电子邮箱", "联系邮箱", "email", "e-mail"),
    "address": ("地址", "住址", "所在地", "通讯地址", "注册地址"),
    "id_number": ("编号", "证件号", "合同号", "项目编号", "税号", "纳税人识别号", "统一社会信用代码", "身份证"),
}
