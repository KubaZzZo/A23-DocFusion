...
class DashboardPanel(QWidget):
    ...
    def _init_ui(self):
        ...
        self.entity_bars_container.setSpacing(2)
        ...
        doc_type_layout.setSpacing(4)
        self.doc_type_bars_container = QVBoxLayout()
        self.doc_type_bars_container.setSpacing(2)
        ...
        self.entity_search_table.setMaximumHeight(150)
        ...
        right_panel_layout.addWidget(right_group)
        ...
        self.fusion_table.setMaximumHeight(190)
        fusion_layout.addWidget(self.fusion_table)
        right_panel_layout.addWidget(fusion_group)
